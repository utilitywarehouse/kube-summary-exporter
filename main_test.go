...
kube_summary_pod_volume_storage_available_bytes{name="data",namespace="mon",node="test.eu-west-1.compute.internal",persistentvolumeclaim="data-dev-server-0",pod="dev-server-0",pvc_namespace="mon",uid="93b0b04d-1ebe-4ad0-ada0-c29172c1ab9c"} 5.36870912e+09
...
kube_summary_pod_volume_storage_capacity_bytes{name="data",namespace="mon",node="test.eu-west-1.compute.internal",persistentvolumeclaim="data-dev-server-0",pod="dev-server-0",pvc_namespace="mon",uid="93b0b04d-1ebe-4ad0-ada0-c29172c1ab9c"} 1.073741824e+10
...
kube_summary_pod_volume_storage_inodes{name="data",namespace="mon",node="test.eu-west-1.compute.internal",persistentvolumeclaim="data-dev-server-0",pod="dev-server-0",pvc_namespace="mon",uid="93b0b04d-1ebe-4ad0-ada0-c29172c1ab9c"} 655360
...
kube_summary_pod_volume_storage_inodes_free{name="data",namespace="mon",node="test.eu-west-1.compute.internal",persistentvolumeclaim="data-dev-server-0",pod="dev-server-0",pvc_namespace="mon",uid="93b0b04d-1ebe-4ad0-ada0-c29172c1ab9c"} 655360
...
kube_summary_pod_volume_storage_inodes_used{name="data",namespace="mon",node="test.eu-west-1.compute.internal",persistentvolumeclaim="data-dev-server-0",pod="dev-server-0",pvc_namespace="mon",uid="93b0b04d-1ebe-4ad0-ada0-c29172c1ab9c"} 0
...
kube_summary_pod_volume_storage_used_bytes{name="data",namespace="mon",node="test.eu-west-1.compute.internal",persistentvolumeclaim="data-dev-server-0",pod="dev-server-0",pvc_namespace="mon",uid="93b0b04d-1ebe-4ad0-ada0-c29172c1ab9c"} 5.36870912e+09
