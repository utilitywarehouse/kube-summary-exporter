...
kube_summary_container_logs_available_bytes{name="dev-server",namespace="mon",pod="dev-server-0"} 9.0016837632e+10
...
kube_summary_container_logs_capacity_bytes{name="dev-server",namespace="mon",pod="dev-server-0"} 1.01535985664e+11
# HELP kube_summary_container_logs_inodes Number of Inodes for logs
# TYPE kube_summary_container_logs_inodes gauge
kube_summary_container_logs_inodes{name="dev-server",namespace="mon",pod="dev-server-0"} 2.5474432e+07
...
kube_summary_container_logs_inodes_free{name="dev-server",namespace="mon",pod="dev-server-0"} 2.5355212e+07
...
kube_summary_container_logs_inodes_used{name="dev-server",namespace="mon",pod="dev-server-0"} 1
...
kube_summary_container_logs_used_bytes{name="dev-server",namespace="mon",pod="dev-server-0"} 8192
...
kube_summary_container_rootfs_available_bytes{name="dev-server",namespace="mon",pod="dev-server-0"} 9.0016837632e+10
...
kube_summary_container_rootfs_capacity_bytes{name="dev-server",namespace="mon",pod="dev-server-0"} 1.01535985664e+11
# HELP kube_summary_container_rootfs_inodes Number of Inodes
# TYPE kube_summary_container_rootfs_inodes gauge
kube_summary_container_rootfs_inodes{name="dev-server",namespace="mon",pod="dev-server-0"} 2.5474432e+07
...
kube_summary_container_rootfs_inodes_free{name="dev-server",namespace="mon",pod="dev-server-0"} 2.5355212e+07
# HELP kube_summary_container_rootfs_inodes_used Number of used Inodes
# TYPE kube_summary_container_rootfs_inodes_used gauge
kube_summary_container_rootfs_inodes_used{name="dev-server",namespace="mon",pod="dev-server-0"} 14
...
kube_summary_container_rootfs_used_bytes{name="dev-server",namespace="mon",pod="dev-server-0"} 114688
...
kube_summary_pod_ephemeral_storage_available_bytes{namespace="mon",pod="dev-server-0"} 9.0016837632e+10
...
kube_summary_pod_ephemeral_storage_capacity_bytes{namespace="mon",pod="dev-server-0"} 1.01535985664e+11
...
kube_summary_pod_ephemeral_storage_inodes{namespace="mon",pod="dev-server-0"} 2.5474432e+07
...
kube_summary_pod_ephemeral_storage_inodes_free{namespace="mon",pod="dev-server-0"} 2.5355212e+07
...
kube_summary_pod_ephemeral_storage_inodes_used{namespace="mon",pod="dev-server-0"} 63
...
kube_summary_pod_ephemeral_storage_used_bytes{namespace="mon",pod="dev-server-0"} 1.33947392e+08
`
